...
class TestSampleApp:
    def test_sample_app_is_loaded(self, sample_app_page):
    ...
    def test_login_is_successful(self, sample_app_page, username, password):
    ...
    def test_login_is_not_successful(self, sample_app_page, username, password):
        sample_app_page.login(username="username", password="password")
        assert sample_app_page.login_failed.is_visible()

    def test_logout_is_successful(self, sample_app_page):
